    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in" id="budget-modal">
      <div className="relative w-full max-w-3xl bg-white border border-neutral-200 rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col animate-scale-up" id="budget-modal-container">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-neutral-200 bg-neutral-50">
          ...
          <button 
            onClick={onClose}
            className="p-1.5 text-neutral-500 hover:text-neutral-900 hover:bg-neutral-205 rounded-lg transition-colors cursor-pointer"
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                  {SERVICES.map(service => (
                    ...
                    >
                      ...
                      <div>
                        <div className="font-bold text-sm text-neutral-850">{service.title}</div>
                        <div className="text-xs text-neutral-550 line-clamp-1 mt-0.5">{service.description}</div>
                      </div>
                    </button>
                  ))}
                </div>
              ...
              {(hasRecarga || hasFumigacaoOrSistemas) && (
                <div className="p-4 bg-neutral-50 border border-neutral-200 rounded-xl space-y-4">
                  <div className="flex items-center space-x-1.5 text-xs text-red-650 font-bold tracking-wide uppercase">
                    ...
                    {hasRecarga && (
                      <div className="space-y-1.5">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <span className="text-sm font-mono text-red-650 font-bold bg-white px-2 py-1 rounded border border-neutral-200 w-14 text-center">
                            {extinguisherCount || 5}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="flex items-center space-x-2">
                          <input 
                            ...
                            className="bg-white border border-neutral-200 rounded-lg px-3 py-1.5 text-sm text-neutral-850 w-full focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 shadow-sm"
                          />
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full bg-white border border-neutral-200 rounded-xl px-4 py-2.5 text-sm text-neutral-850 focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 placeholder:text-neutral-400 transition-all shadow-sm"
                    />
                  </div>
                  <div className="space-y-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-neutral-200 rounded-xl px-4 py-2.5 text-sm text-neutral-850 focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 shadow-sm cursor-pointer"
                    >
                ...
                <div className="space-y-1 mt-2">
                  <span className="text-xs text-neutral-605 block font-semibold">Mensagem / Detalhes Adicionais (Opcional)</span>
                  <textarea 
                    rows={3}
                    ...
                    className="w-full bg-white border border-neutral-200 rounded-xl p-4 text-sm text-neutral-850 focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 placeholder:text-neutral-400 transition-all resize-none shadow-sm"
                  />
                </div>
              </div>
              ...
              <div className="flex justify-end space-x-3 pt-2">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-5 py-2.5 text-sm font-semibold text-neutral-550 hover:text-neutral-900 hover:bg-neutral-100 rounded-xl transition-all cursor-pointer"
                >
                  Cancelar
                </button>
                <button
            ...
            <div className="py-8 text-center space-y-6 animate-fade-in flex flex-col items-center">
              ...
              <div className="space-y-2 max-w-md">
                <h3 className="font-display font-bold text-2xl text-neutral-900">Dados Recebidos com Sucesso!</h3>
                <p className="text-sm text-neutral-600 leading-relaxed">
                  Agradecemos o seu contacto, <span className="font-bold text-neutral-900">{formData.name}</span>. Registámos os detalhes técnicos solicitados para o seu orçamento e daremos prioridade imediata à sua cotação.
                </p>
              </div>

              <div className="p-4 bg-neutral-50 border border-neutral-200 rounded-xl max-w-md text-xs text-neutral-600 leading-relaxed">
                <p className="font-bold text-neutral-900 mb-1">Passo Recomendado 👇</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2 w-full max-w-md justify-center">
                <button
                  ...
                  className="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold text-sm rounded-xl flex items-center justify-center space-x-2 shadow hover:-translate-y-0.5 transition-all cursor-pointer w-full sm:w-auto"
                >
                ...
                <button
                  ...
                  className="px-5 py-3 border border-neutral-300 hover:border-neutral-400 text-neutral-605 hover:text-neutral-900 font-semibold text-sm rounded-xl transition-all cursor-pointer w-full sm:w-auto"
                >
                  Fechar Janela
                </button>
              </div>
