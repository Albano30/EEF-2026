    ...
    <section className="py-20 bg-neutral-950 border-t border-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="font-display font-black text-3xl text-white tracking-tight leading-none mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map(t => (
            <div 
              key={t.id}
              className="bg-neutral-900 border border-neutral-850 p-6 rounded-2xl flex flex-col justify-between hover:border-neutral-750 transition-colors shadow-lg"
            >
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Quote className="h-6 w-6 text-neutral-800 rotate-180" />
                </div>

                <p className="font-sans text-sm text-neutral-300 italic leading-relaxed">
                  "{t.text}"
                </p>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-neutral-800/80 flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono font-bold text-red-400 tracking-wider bg-red-950/20 px-2 py-1 rounded">
                  {t.company}
                </span>
              </div>
            </div>
